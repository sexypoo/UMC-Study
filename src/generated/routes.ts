...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserController_handleListUserReview: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
                cursor: {"default":0,"in":"query","name":"cursor","dataType":"double"},
        };
        app.get('/users/:userId/reviews',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.handleListUserReview)),

            async function UserController_handleListUserReview(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserController_handleListUserMission: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
                cursor: {"default":0,"in":"query","name":"cursor","dataType":"double"},
        };
        app.get('/users/:userId/missions',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.handleListUserMission)),

            async function UserController_handleListUserMission(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsRestaurantController_handleListRestaurantReviews: Record<string, TsoaRoute.ParameterSchema> = {
                resId: {"in":"path","name":"resId","required":true,"dataType":"double"},
                cursor: {"default":0,"in":"query","name":"cursor","dataType":"double"},
        };
        app.get('/restaurants/:resId/reviews',
            ...(fetchMiddlewares<RequestHandler>(RestaurantController)),
            ...(fetchMiddlewares<RequestHandler>(RestaurantController.prototype.handleListRestaurantReviews)),

            async function RestaurantController_handleListRestaurantReviews(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsRestaurantController_handleListRestaurantMissions: Record<string, TsoaRoute.ParameterSchema> = {
                resId: {"in":"path","name":"resId","required":true,"dataType":"double"},
                cursor: {"default":0,"in":"query","name":"cursor","dataType":"double"},
        };
        app.get('/restaurants/:resId/missions',
            ...(fetchMiddlewares<RequestHandler>(RestaurantController)),
            ...(fetchMiddlewares<RequestHandler>(RestaurantController.prototype.handleListRestaurantMissions)),

            async function RestaurantController_handleListRestaurantMissions(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserMissionController_handleStartMission: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
        ...
        app.post('/users/:userId/missions',
            ...
            ...(fetchMiddlewares<RequestHandler>(UserMissionController.prototype.handleStartMission)),

            async function UserMissionController_handleStartMission(request: ExRequest, response: ExResponse, next: any) {
